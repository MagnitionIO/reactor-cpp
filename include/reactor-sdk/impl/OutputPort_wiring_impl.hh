...
template <typename T>
void Output<T>::connect_multiport(MultiportInput<T>& input) {
    if (is_accumulated) {
...
void Output<T>::connect_multiport(std::vector<std::unique_ptr<ReactorType>>* reactors, Input<T> ReactorType::*member) {
...
template <typename T>
template <typename ReactorType>
void Output<T>::connect_multiport(ReactorBankInputPort<ReactorType, T> &&other_bank_ports) {
...
template <typename T>
template <typename ReactorType>
void Output<T>::connect_multiport(ReactorBankInputPortOffset<ReactorType, T> &&other_bank_ports) {
